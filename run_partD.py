...
""")
    ...
    macros = [
        ...
        mac("DfcfsExtraActs", f"{t2['acts']-t1['acts']:.0f}"),
        mac("DfcfsActsPct", f"{100*(t2['acts']/t1['acts']-1):.0f}"),
        mac("DfcfsActCost", f"{(t2['acts']-t1['acts'])*(TIMING['tRP']+TIMING['tRCD']):.0f}"),
        mac("DfcfsSlowCyc", f"{t2['cycles']-t1['cycles']:.0f}"),
        mac("DfcfsActShare",
            f"{100*(t2['acts']-t1['acts'])*(TIMING['tRP']+TIMING['tRCD'])/(t2['cycles']-t1['cycles']):.0f}"),
        mac("DfcfsBankShare",
            f"{100*(1-(t2['acts']-t1['acts'])*(TIMING['tRP']+TIMING['tRCD'])/(t2['cycles']-t1['cycles'])):.0f}"),
